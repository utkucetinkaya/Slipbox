...
exports.viewSharedExport = exports.createShareLink = void 0;
...
exports.createShareLink = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        if (!entitlements.exists || !((_a = entitlements.data()) === null || _a === void 0 ? void 0 : _a.isPro)) {
            throw new functions.https.HttpsError("permission-denied", "Pro subscription required for share links");
        }
        ...
        const baseUrl = ((_b = functions.config().app) === null || _b === void 0 ? void 0 : _b.url) || "https://yourapp.web.app";
        return {
            url: `${baseUrl}/s/${token}`,
            token,
        };
        ...
        throw new functions.https.HttpsError("internal", "Failed to create share link");
    }
});
/**
 ...
 * Route: /s/:token
 */
exports.viewSharedExport = functions.https.onRequest(async (req, res) => {
    var _a;
    ...
    try {
        ...
        <head>
          ...
          <title>FişKutusu AI - Paylaşılan Rapor</title>
          <style>
          ...
          <div class="container">
            ...
            <div class="info">
              ...
              <div class="info-row">
                ...
                <span class="value">${new Date((_a = exportData.createdAt) === null || _a === void 0 ? void 0 : _a.toDate()).toLocaleDateString("tr-TR")}</span>
              </div>
            </div>
